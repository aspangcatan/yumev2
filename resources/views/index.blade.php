...
<section class="relative pt-8 text-white px-4 sm:px-8 overflow-hidden">
    ...
    <img src="{{ asset('img/img-home-4.png') }}"
         alt="YUME Background"
         class="hidden sm:block absolute inset-x-0 bottom-0 left-1/2 transform -translate-x-1/2 w-[70vw] md:w-[55vw] lg:w-[40vw] xl:w-[32gvw] 2xl:w-[27w] max-w-none object-contain pointer-events-none"/>
